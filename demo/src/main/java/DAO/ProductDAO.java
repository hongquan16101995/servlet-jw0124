...
public class ProductDAO {
	...
	private static final String DELETE_BY_CATEGORY = "update product set status = 1 where c_id = ?;";
	...
	private static final String DELETE_CATEGORY_BY_ID = "update category set status = 1 where id = ?;";
	...
	public void deleteCategoryAndProduct(int id) {
	...
	public void deleteByCategory(int cId) {
		try (PreparedStatement preparedStatement = connection.prepareStatement(DELETE_BY_CATEGORY);) {
